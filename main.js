...
{// This is our "level editor", where all the rooms are created (using the addRoom method rooms.js)
	...
	addRoom(1,2, "Bill and Ted's phone booth", "You see a phone booth, inside is a phone book but instead of names and numbers it seems to be dates in history?and on the cover 'San Dimas High School Footbal Rules' is scribbled.  Wierd.");
